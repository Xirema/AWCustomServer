...
int main(int argc, char const** argv) {
  try {
    ...
    std::string_view clientMessage = e.get_diagnostics().client_message(), serverMessage = e.get_diagnostics().server_message();
    std::println("ERROR: {}: {}", clientMessage, serverMessage);
  }
}