...
std::vector<dTypes::MapMetadata> findMaps(std::string_view name, std::optional<std::string_view> version, std::optional<int64_t> modId);
...
void createGame(std::optional<int64_t> gameId, int64_t mapId, std::map<std::string_view, sTypes::PlayerState> users, sTypes::SettingsState const& settings);
